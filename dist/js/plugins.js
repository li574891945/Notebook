...
jQuery.migrateMute === void 0 && (jQuery.migrateMute = !0),
    function(e, t, n) {
        ...
        function r(n) {
            ...
            t.console && console.warn && !e.migrateMute && (console.warn("JQMIGRATE: " + n),
        ...
        a(e, "attrFn", i, "jQuery.attrFn is deprecated"),
            e.attr = function(t, a, o, i) {
                var u = a.toLowerCase()
                    , c = t && t.nodeType;
                return i && 4 > s.length && (r("jQuery.fn.attr( props, pass ) is deprecated"),
                t && !d.test(c) && e.isFunction(e.fn[a])) ? e(t)[a](o) : ("type" === a && o !== n && l.test(t.nodeName) && t.parentNode && r("Can't change the 'type' of an input or button in IE 6/7/8"),
        ...
        e.fn.init = function(t, n, a) {
            ...
            n && n.context && (n = n.context),
                e.parseHTML) ? v.call(this, e.parseHTML(e.trim(t), n, !0), n, a) : v.apply(this, arguments)
        }
            ,
        ...
        e.fn.data = function(t) {
            var a, o, i = this[0];
            return !i || "events" !== t || 1 !== arguments.length || (a = e.data(i, t),
                o = e._data(i, t),
                ...
                if (e.merge(d, e.buildFragment(t, a).childNodes),
                    ...
                    for (c = function(e) {
                        return !e.type || j.test(e.type) ? i ? i.push(e.parentNode ? e.parentNode.removeChild(e) : e) : o.appendChild(e) : n
                             ...
                             ,
                             s = 0; null != (u = d[s]); s++)
                        e.nodeName(u, "script") && c(u) || (o.appendChild(u),
        ...
        e.event.dispatch && a(e.event, "handle", e.event.dispatch, "jQuery.event.handle is undocumented and deprecated"),
            ...
            e.fn.live = function(t, n, a) {
                return r("jQuery.fn.live() is deprecated"),
                    C ? C.apply(this, arguments) : (e(this.context).on(t, this.selector, n, a),
                        this)
            }
            ,
            e.fn.die = function(t, n) {
                return r("jQuery.fn.die() is deprecated"),
                    T ? T.apply(this, arguments) : (e(this.context).off(t, this.selector || "**", n),
                        this)
            }
            ,
            e.event.trigger = function(e, t, n, a) {
                return !n & !S.test(e) && r("Global events are undocumented and deprecated"),
...
(function(a) {
        ...
        var K, L = function() {
            return K === undefined && (K = document.createElement("p").style.MozTransform !== undefined),
                K
        };
        a.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function(b) {
                    ...
                    return L() ? g["-moz-transform"] = g.transform = "translate(" + d.left + "px," + d.top + "px)" : (g.left = d.left,
                        g.top = d.top),
                        g
                }
            }
...
)(window.jQuery || window.Zepto)// jquery CollagePlus Plugin
;
(function(e) {
...
;if (document.getElementById("email")) {
    document.getElementById("email").onblur = function() {
        if (/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2，3}){1，2})$/.test(this.value))
            document.getElementById("commentform").getElementsByTagName("img")[0].src = "http://cn.gravatar.com/avatar/" + hex_md5(this.value) + "？d=mm&s=80"
    }
}
;// Remove Spaces
(function(a) {
